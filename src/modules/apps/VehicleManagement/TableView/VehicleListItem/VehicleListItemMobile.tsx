...
const DealerListItemWrapper = styled(ListItem)(({ theme }) => {
  return {
    display: "flex",
    flexDirection: "row",
    fontSize: 14,
...
const DealerListItemMobile = ({ dealer }: Props) => {
  return (
    <DealerListItemWrapper dense key={dealer.dlr_code}>
      <Box
        sx={{
    ...
    </DealerListItemWrapper>
  );
};

export default DealerListItemMobile;
