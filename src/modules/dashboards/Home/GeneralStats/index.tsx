...
const getIcon = (iconType: string) => {
  switch (iconType) {
    case "BiBasket":
      return <GoProjectRoadmap color="#9E49E6" className="icon" />;
    case "FcGraduationCap":
      return <FaMoneyBillWheat color="#0A8FDC" className="icon" />;
    case "GiBookshelf":
      return <GiTakeMyMoney color="#49BD65" className="icon" />;
    default:
      return <FaRegMoneyBill1 color="#9E49E6" className="icon" />;
  }
};
