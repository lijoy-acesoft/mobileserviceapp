...
const routesConfig = [

  {
    id: "dashboard",
    title: "Dashboard",
    messageId: "sidebar.home.dashboard",
    type: "item",
    icon: <RxDashboard />,
    url: "/apps/dashboard",
  },
  {
    id: "serviceEntry",
    title: "Service Entry",
    messageId: "sidebar.home.projects",
    type: "item",
    icon: <AiOutlineProject />,
    url: "/apps/service_entry",
  },
  {
    id: "service_details",
  ...
  },
  {
    id: "checkout",
    title: "Check-out",
    messageId: "sidebar.home.summery.checkout",
    type: "item",
  ...
  
  {
    id: "technician",
    title: "technician",
    messageId: "sidebar.home.create-technician",
    type: "item",
    icon: <HiOutlineShoppingCart />,
    url: "/apps/technician-master",
  },
  
  // {
  //   id:"technecian",
  //   title:"Technecian",
  //   messageId:"sidebar.home.create-technecian",
  //   type:"item",
  //   icon: <HiOutlineShoppingCart />,
  //   url:"apps/create-technecian",
  // },
  {
    id: "add",
    title: "Details", 
    messageId: "sidebar.home.details",
    type: "collapse",
    icon: <TbUsers />,
    children: [
      {
        id: "add_customer",
        title: "Customer",
        messageId: "sidebar.home.details.addCustomer",
        type: "item",
        icon: <FaUser />,
 ...
 
  {
    id: "inventory",
    title: "Inventory",
    messageId: "sidebar.home.inventory",
    type: "collapse",
    ...
    children: [
      {
        id: "category",
        title: "Category",
        messageId: "sidebar.home.inventory.category",
        type: "item",
        icon: <FaShop />,
        url: "/apps/inventory/category",
      },
      {
        id: "sub_category",
        title: "Sub Category",
        messageId: "sidebar.home.inventory.sub_category",
        type: "item",
        icon: <HiShoppingBag />,
        url: "/apps/inventory/sub_category",
      },
      {
        id: "products",
        title: "Products",
        messageId: "sidebar.home.inventory.product",
        type: "item",
        icon: <TiShoppingCart />,
  ...
  //   id: "project-tasks",
  //   // title: "Employees",
  //   // messageId: "sidebar.home.employees",
  //   type: "link",
  //   url: "/apps/projects/:projectID/tasks",
  // },
  // {
  //   id: "location_setups",
  //   title: "Location Setups",
  //   messageId: "sidebar.location_setups",
  //   type: "collapse",
  //   icon: <FaGlobeEurope />,
  //   children: [
  //     {
  //       id: "company_group",
  //       title: "Company Group",
  //       messageId: "sidebar.location_setups.company_group",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/company-group",
  //       icon: <GiPipeOrgan />,
  //     },
  //     {
  //       id: "sitemaster",
  //       title: "SiteMaster",
  //       messageId: "sidebar.location_setups.sitemaster",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/sitemaster",
  //       icon: <CiLocationOn />,
  ...
  //       messageId: "sidebar.location_setups.building_master",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/building-master",
  //       icon: <LuBuilding2 />,
  //     },
  //     {
  //       id: "floor_master",
  //       title: "Floor Master",
  //       messageId: "sidebar.location_setups.floor_master",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/floor-master",
  //       icon: <RiHome6Line />,
  //     },
  //     {
  //       id: "room_master",
  //       title: "Room Master",
  //       messageId: "sidebar.location_setups.room_master",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/room-master",
  //       icon: <MdOutlineMeetingRoom />,
  //     },
  //     {
  //       id: "location",
  //       title: "Location",
  //       messageId: "sidebar.location_setups.location",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/location",
  //       icon: <FaMapMarkedAlt />,
  ...
  //       id: "layout_view",
  //       title: "Layout View",
  //       messageId: "sidebar.location_setups.layout_view",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/layout-view",
  ...
  //   messageId: "sidebar.asset_attributes",
  //   type: "collapse",
  //   icon: <FaBox />,
  //   children: [
  //     {
  ...
  //       messageId: "sidebar.asset_attributes.asset_category",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  ...
  //       messageId: "sidebar.asset_attributes.asset_subcategory",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/asset-subcategories",
  //       icon: <MdOutlineCategory />,
  //     },
  //     {
  //       id: "brand_master",
  //       title: "Brand Master",
  //       messageId: "sidebar.asset_attributes.brand_master",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/brand-masters",
  //       icon: <TbBrandAlipay />,
  //     },
  //     {
  //       id: "model_master",
  //       title: "Model Master",
  //       messageId: "sidebar.asset_attributes.model_master",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/model-masters",
  //       icon: <RxBoxModel />,
  //     },
  //     {
  //       id: "product_master",
  //       title: "Product Master",
  //       messageId: "sidebar.asset_attributes.product_master",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/product-masters",
  //       icon: <FaProductHunt />,
  //     },
  //     {
  //       id: "department_master",
  //       title: "Department Master",
  //       messageId: "sidebar.asset_attributes.department_master",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/department-masters",
  //       icon: <GoBriefcase />,
  //     },
  //     {
  //       id: "employee_master",
  //       title: "Employee Master",
  //       messageId: "sidebar.asset_attributes.employee_master",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/employee-masters",
  //       icon: <FaUserTie />,
  //     },
  //     {
  //       id: "supplier_master",
  //       title: "Supplier Master",
  //       messageId: "sidebar.asset_attributes.supplier_master",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/supplier-masters",
  //       icon: <FaBuildingUser />,
  //     },
  //     {
  //       id: "customer_master",
  //       title: "Customer Master",
  //       messageId: "sidebar.asset_attributes.customer_master",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/customer-masters",
  //       icon: <FaUsers />,
  //     },
  //   ],
  // },
  ...
  //   id: "transactions",
  //   title: "Transactions",
  //   messageId: "sidebar.transactions",
  //   type: "collapse",
  //   icon: <GrTransaction />,
  //   children: [
  //     {
  //       id: "receipt",
  //       title: "Receipt",
  //       messageId: "sidebar.transactions.receipt",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/receipt",
  ...
  //       messageId: "sidebar.transactions.asset_register",
  //       type: "item",
  //       permittedRole: [RoutePermittedRole.User],
  //       url: "/apps/asset-register",
  //       icon: <FaCashRegister />,
  //     },
  //   ],
  // },
